        ...
        <div class="col-xxl-4 col-xl-4 col-lg-5 col-md-7 col-sm-9">
            ...
            <div class="card shadow p-1 mt-5 bg-white rounded">
                <div class="card-body p-2">
                    <div class="card-title mb-4 text-center text-success">Registration  or <a href="/login" class="text-success">Login</a></div>
                    ...
                    <form action="/registration" method="post">
                        ...
                        <div class="d-flex align-items-center">
                            <button class="btn btn-outline-success ms-auto" type="submit">REGISTRATION</button>
                        </div>
